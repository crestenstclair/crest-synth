...
project: witnesses: running_synth: {
	...
	predicates: [
			...
			{field: "soundfont_catalog_entries", op: "gt", value: 1},
			{field: "soundfont_catalog_order_exact", op: "eq", value: true},
			{field: "fixture_preset_choices_exact", op: "eq", value: true},
...
project: witnesses: exhaustive_demo_scene: {
	...
	observation: {
		...
		marker: "CREST_OBSERVATION "
			...
			window_input_cases_exercised: "number"
				semantic_action_variants_exercised: "number"
	...
	predicates: [
		...
		{field: "semantic_action_variants_exercised", op: "eq", value: 6, repairResources: ["valueObject.Control.SemanticAction", "applicationService.Shell.KeyboardInputTranslator", "valueObject.Testing.DemoScene", "applicationService.Control.AppLoop"]},
		{field: "app_event_variants_exercised", op: "eq", value: 11, repairResources: ["valueObject.Control.AppEvent", "valueObject.Testing.DemoScene", "applicationService.Control.AppLoop"]},
		...
		{field: "semantic_surfaces_exercised", op: "eq", value: 4, repairResources: ["valueObject.Control.SurfaceId", "valueObject.Control.FocusPath", "valueObject.Testing.DemoScene", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "interaction_modes_exercised", op: "eq", value: 2, repairResources: ["valueObject.Control.InteractionMode", "valueObject.Control.SemanticAction", "valueObject.Testing.DemoScene", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "return_path_round_trips", op: "eq", value: 2, repairResources: ["valueObject.Control.ReturnPath", "aggregate.Control.AppState", "valueObject.Testing.DemoScene", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "valid_actions_exact", op: "eq", value: true, repairResources: ["valueObject.Control.ValidAction", "aggregate.Control.AppState", "domainService.Control.StateProjector", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "focus_recovery_exact", op: "eq", value: true, repairResources: ["valueObject.Control.FocusPath", "aggregate.Control.AppState", "domainService.Control.StateProjector", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "semantic_status_errors_exact", op: "eq", value: true, repairResources: ["valueObject.Control.SemanticGraphicalViewModel", "valueObject.Control.EngineSelectionStatus", "domainService.Control.StateProjector", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "event_sources_exercised", op: "eq", value: 6, repairResources: ["valueObject.Control.EventRecord", "applicationService.Control.AppLoop", "applicationService.Testing.AutomaticMidiTest", "applicationService.Shell.StandaloneApplication"]},
		...
		{field: "patch_effect_structural_preservation", op: "eq", value: true, repairResources: ["aggregate.Control.AppState", "applicationService.RealTime.StructuralGraphCoordinator", "applicationService.Testing.ExhaustiveGuiDemo"]},
			...
			{field: "soundfont_preset_names_exact", op: "eq", value: true, repairResources: ["adapter.HiDefSoundFontAsset", "valueObject.Synth.SoundFontPresetCatalog", "domainService.Control.StateProjector"]},
			{field: "soundfont_preset_target_audio_distinct", op: "eq", value: true, repairResources: ["adapter.HiDefSoundFontPreparer", "applicationService.RealTime.AudioRenderer", "applicationService.Testing.ExhaustiveGuiDemo"]},
			{field: "soundfont_preset_structural_coexistence_exact", op: "eq", value: true, repairResources: ["aggregate.Control.AppState", "applicationService.Control.AppLoop", "applicationService.RealTime.StructuralGraphCoordinator", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "all_editable_parameter_cases_exercised", op: "eq", value: true, repairResources: ["valueObject.Mixer.PatchOutput", "valueObject.Mixer.MixerTrackParameters", "valueObject.Testing.DemoScene", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "final_state_tree_matches", op: "eq", value: true, repairResources: ["valueObject.Control.StateTree", "domainService.Control.StateProjector", "valueObject.Testing.DemoSceneReport"]},
			{field: "gui_projection_matches_state", op: "eq", value: true, repairResources: ["valueObject.Control.SemanticGraphicalViewModel", "valueObject.Control.GraphicalShellProjection", "valueObject.Control.TextProjection", "domainService.Control.StateProjector", "adapter.EframeGraphicalWindow"]},
		...
		{field: "all_audio_parameter_effects_observed", op: "eq", value: true, repairResources: ["valueObject.Mixer.PatchOutput", "valueObject.Mixer.MixerTrackParameters", "valueObject.Mixer.GlobalParameters", "adapter.GlobalReverbDelay", "domainService.Mixer.MixEngine", "applicationService.RealTime.AudioRenderer", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "post_rejection_event_accepted", op: "eq", value: true, repairResources: ["aggregate.Control.AppState", "applicationService.Control.AppLoop", "applicationService.Testing.ExhaustiveGuiDemo", "applicationService.Shell.StandaloneApplication"]},
			{field: "schema_surface_equal", op: "eq", value: true, repairResources: ["valueObject.Control.TopLevelContext", "valueObject.Control.SemanticAction", "valueObject.Control.SurfaceId", "valueObject.Control.InteractionMode", "valueObject.Control.FocusPath", "valueObject.Control.ReturnPath", "valueObject.Control.ValidAction", "valueObject.Control.InteractionState", "valueObject.Control.AppEvent", "valueObject.Control.EventRecord", "valueObject.Control.EventLog", "valueObject.Control.StateTree", "valueObject.Control.PatchPageProjection", "valueObject.Control.SemanticGraphicalViewModel", "valueObject.Control.GraphicalShellProjection", "valueObject.Control.TextProjection", "domainService.Control.StateProjector", "valueObject.Testing.DemoScene"]},
		...
		{field: "exact_state_values", op: "eq", value: true, repairResources: ["aggregate.Control.AppState", "valueObject.Control.StateTree", "domainService.Control.StateProjector", "applicationService.Testing.ExhaustiveGuiDemo"]},
			{field: "exact_projection_values", op: "eq", value: true, repairResources: ["valueObject.Control.SemanticGraphicalViewModel", "valueObject.Control.GraphicalShellProjection", "valueObject.Control.TextProjection", "valueObject.RealTime.ParameterSnapshot", "domainService.Control.StateProjector", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "reverb_input_nonzero", op: "eq", value: true, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "delay_input_nonzero", op: "eq", value: true, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "descriptors_unique", op: "eq", value: true, repairResources: ["valueObject.Shell.WindowInput", "valueObject.Control.SemanticAction", "valueObject.Control.AppEvent", "valueObject.Kernel.MidiMessage", "valueObject.Mixer.PatchOutput", "valueObject.Mixer.MixerTrackParameters", "valueObject.Mixer.GlobalParameters", "valueObject.Testing.DemoScene"]},
		...
		{field: "all_parameter_boundaries_exercised", op: "eq", value: true, repairResources: ["aggregate.Control.AppState", "valueObject.Mixer.PatchOutput", "valueObject.Mixer.MixerTrackParameters", "valueObject.Mixer.GlobalParameters", "valueObject.Testing.DemoScene", "applicationService.Testing.ExhaustiveGuiDemo"]},
...
project: witnesses: cross_track_parameter_leak_mutant: {
	scope: "goal"
	goal: "goal.observe_synth"
	capability: "capability.observable_demo_scene"
	resources: [
	...
	counterexampleRepairResources: ["applicationService.Testing.BehavioralMutationHarness", "asset.BehavioralWitnessMain"]
	evidence: ["evidence.mutation_resistance"]
	command: ["cargo", "run", "--quiet", "--bin", "crest-synth-witness", "--", "--case", "cross-track-parameter-leak", "--mutant", "none"]
	negativeCommand: ["cargo", "run", "--quiet", "--bin", "crest-synth-witness", "--", "--case", "cross-track-parameter-leak", "--mutant", "cross-track-parameter-leak"]
	negativeExpectedExitCode: 1
	timeout: "60s"
	artifacts: ["target/debug/crest-synth-witness"]
	observation: {
	...
	predicates: [
		{field: "case", op: "eq", value: "cross-track-parameter-leak", repairResources: ["applicationService.Testing.BehavioralMutationHarness", "asset.BehavioralWitnessMain"]},
		{field: "edited_track_id", op: "lt", value: 16, repairResources: ["valueObject.Mixer.MixerTrackId", "aggregate.Control.AppState", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "comparison_track_id", op: "lt", value: 16, repairResources: ["valueObject.Mixer.MixerTrackId", "aggregate.Control.AppState", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "track_ids_distinct", op: "eq", value: true, repairResources: ["valueObject.Mixer.MixerTrackId", "aggregate.Control.AppState", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "parameter_cases_exercised", op: "eq", value: 6, repairResources: ["valueObject.Mixer.MixerTrackParameters", "applicationService.Testing.ExhaustiveGuiDemo", "applicationService.Testing.BehavioralMutationHarness"]},
		{field: "edited_track_energy_before", op: "gt", value: 0, repairResources: ["valueObject.Mixer.MixObservation", "applicationService.RealTime.AudioRenderer", "domainService.Mixer.MixEngine"]},
		{field: "comparison_track_energy_before", op: "gt", value: 0, repairResources: ["valueObject.Mixer.MixObservation", "applicationService.RealTime.AudioRenderer", "domainService.Mixer.MixEngine"]},
		...
		{field: "edited_track_audio_changed", op: "eq", value: true, repairResources: ["applicationService.RealTime.AudioRenderer", "domainService.Mixer.MixEngine"]},
		{field: "unedited_track_audio_unchanged", op: "eq", value: true, repairResources: ["valueObject.RealTime.ParameterSnapshot", "applicationService.RealTime.AudioRenderer", "domainService.Mixer.MixEngine"]},
		{field: "all_track_parameters_isolated", op: "eq", value: true, repairResources: ["valueObject.Mixer.MixerTrackParameters", "valueObject.RealTime.ParameterSnapshot", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
...
project: witnesses: dry_to_wet_bypass_mutant: {
	...
	predicates: [
		...
		{field: "zero_send_reverb_input_energy", op: "eq", value: 0, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "zero_send_delay_input_energy", op: "eq", value: 0, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
		...
		{field: "nonzero_send_reverb_input_energy", op: "gt", value: 0, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
		{field: "nonzero_send_delay_input_energy", op: "gt", value: 0, repairResources: ["valueObject.Mixer.MixerTrackParameters", "domainService.Mixer.MixEngine", "applicationService.Testing.ExhaustiveGuiDemo"]},
...
project: witnesses: per_voice_envelope: {
	...
	predicates: [
		...
		{field: "patch_control_cases_exercised", op: "eq", value: 4},
		{field: "patch_focus_order_exact", op: "eq", value: true},
		{field: "fine_coarse_adjustment_exact", op: "eq", value: true},
		{field: "mixer_patch_mutation_shared", op: "eq", value: true},
		{field: "scalar_only_publication", op: "eq", value: true},
		{field: "target_patch_isolated", op: "eq", value: true},
