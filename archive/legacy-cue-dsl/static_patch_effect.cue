...
project: capabilities: static_patch_effect: {
	...
	acceptance: configured_chorus_insert: {
		...
		steps: [
			...
			{action: "render simultaneous configured and unconfigured Patches", observes: "the Chorus processes the configured engine stem before Patch trim and fixed track routing; untargeted stems remain exact and independently prepared Chorus instances retain independent delay/LFO state"},
