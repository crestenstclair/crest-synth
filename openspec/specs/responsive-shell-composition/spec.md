...
## Purpose
Defines responsive shell regions, stable semantic focus, accessible controls, and truthful state presentation across native window sizes without making layout part of product state.
## Requirements
