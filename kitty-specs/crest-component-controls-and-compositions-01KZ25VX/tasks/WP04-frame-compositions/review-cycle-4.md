...
reviewed_at: '2026-08-03T04:00:06Z'
...
> The body below is byte-identical to `review-cycle-3.md` — the *previous* cycle's rejection,
...
> The outer frontmatter is corrected to `WP04`'s real final outcome: **approved**.
> Nothing in the body is altered — the rejection it records genuinely happened, one
> cycle earlier, in `review-cycle-3.md`.
