...
project: witnesses: exhaustive_demo_scene: {
	...
	predicates: [
		...
		{field: "app_event_variants_exercised", op: "eq", value: 8, repairResources: ["valueObject.Control.AppEvent", "valueObject.Testing.DemoScene", "applicationService.Control.AppLoop"]},
