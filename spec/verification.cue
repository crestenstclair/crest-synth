...
project: witnesses: patch_misroute_mutant: {
	...
	predicates: [
		...
		{field: "target_patch_received_command", op: "eq", value: true, repairResources: ["adapter.LockFreeAudioBoundary", "applicationService.RealTime.AudioRenderer", "port.Synth.SoundFontEngine", "adapter.HiDefSoundFontEngine"]},
